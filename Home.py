...
with tab_intro:
  ...
  Su objetivo principal es consolidar la base de datos específica de cada proyecto según su tipo de energía. Permite el registro estructurado, almacenamiento y análisis comparativo de los indicadores evaluados, garantizando un repositorio centralizado, estandarizado y seguro para todas las instituciones aliadas.
    """)
